 ...
 * VERSIÓN:   2.1.4 (Reanimación ESM + Reparación de Grafo R0)
...
import { FirebaseConnector } from './firebase-triple-write.js';
...
export const PassportEngine = Object.freeze({
    init: function () {
        ...
        console.log('[PASSPORT-ENGINE] ✅ Motor de Pasaportes (v2.1.4) blindado e íntegro.');
    },
    ...
    _handleUIActionRequest: function (detail) {
        ...
        if (action === AIP_CONSTANTS.ACTIONS.LEAD_SUBMIT) {
            ...
            FirebaseConnector.executeTripleWrite(credential, {}).then((res) => {

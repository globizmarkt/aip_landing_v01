...
(function (global) {
    ...
    if (!global.Skeleton) global.Skeleton = {};
    global.Skeleton.GoldenGate = Object.freeze(GoldenGate);

    // Auto-inicialización si el DOM está listo
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => global.Skeleton.GoldenGate.init());
    } else {
        global.Skeleton.GoldenGate.init();
    }
